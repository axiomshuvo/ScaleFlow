  ...
  return (
    <details className="group border-b border-slate-100 dark:border-slate-700 py-1">
      <summary className="flex items-center justify-between py-4 cursor-pointer list-none">
        ...
        <span className="w-7 h-7 rounded-full bg-indigo-100 dark:bg-indigo-900 text-indigo-700 dark:text-indigo-300 flex items-center justify-center shrink-0 font-bold text-lg transition group-open:rotate-45">
          +
        </span>
      </summary>
